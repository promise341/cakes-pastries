    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-6">
                <div class="hidden md:flex items-center gap-6 mr-1">
                    @guest
                    ...
                    @else
                        ...
                        @endif
                        <a href="javascript:void(0)" onclick="document.getElementById('logoutForm').submit()" class="nav-link text-rose-300 hover:text-rose-400">Logout</a>
                    @endguest
                </div>

                @php $cartCount = collect(session('cart', []))->sum('quantity'); @endphp
                <a href="javascript:void(0)" onclick="toggleCartDrawer(true)" class="relative hover:text-rose-400 transition-colors shrink-0" style="color:#F5E6D0">
                ...
                <button id="mobileMenuBtn" class="md:hidden shrink-0" style="color:#F5E6D0">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
